...
public class TcTable2 extends Baseclass
{	
	LoginPage lp;
	HomePage hp;
	EmpMgtPage emp;
	...
	public void PrintEmpWithSubUnitQATEAM()
	{
		...
		String expColumn = "Sub Unit";
		String expSubUnitValue="QA Team";
		int QATeamColumnIndex = TData.get(0).indexOf(expColumn);
		for(int i=1; i<TData.size();i++)
		{	
			if(expSubUnitValue.contains(TData.get(i).get(QATeamColumnIndex)))
			{
